...
public class CbbSearchStrategy implements VendorSearchStrategy {
    ...
    public Vendor getVendor() {
        return Vendor.COMPANYBOX;
    }

    @Override
    public void searchProduct(String productName) {
        log.info("Executing CBB-specific search for: {}", productName);

        // CBB is a 3P vendor, so we pass "3P" to the CatalogService
        ...
        log.info("CBB Search Complete. Saved SKU [{}] to context for product [{}]", sku, productName);
    }
}