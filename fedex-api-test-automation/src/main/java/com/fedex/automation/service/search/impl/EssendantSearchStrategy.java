...
public class EssendantSearchStrategy implements VendorSearchStrategy {
    ...
    public Vendor getVendor() {
        return Vendor.ESSENDANT;
    }

    @Override
    public void searchProduct(String productName) {
        log.info("Executing Essendant-specific search for: {}", productName);

        // Essendant is a 3P vendor, so we pass "3P" to the CatalogService
        ...
        log.info("Essendant Search Complete. Saved SKU [{}] to context for product [{}]", sku, productName);
    }
}