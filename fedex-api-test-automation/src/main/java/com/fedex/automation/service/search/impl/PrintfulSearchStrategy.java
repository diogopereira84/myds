...
public class PrintfulSearchStrategy implements VendorSearchStrategy {
    ...
    public Vendor getVendor() {
        return Vendor.PRINTFUL;
    }

    @Override
    public void searchProduct(String productName) {
        log.info("Executing Printful-specific search for: {}", productName);

        // Printful is a 3P vendor, so we pass "3P" to the CatalogService
        ...
        log.info("Printful Search Complete. Saved SKU [{}] to context for product [{}]", sku, productName);
    }
}