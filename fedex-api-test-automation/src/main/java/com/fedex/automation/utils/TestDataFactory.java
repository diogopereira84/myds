...
public class TestDataFactory {
    ...
    private static final String TELEPHONE = "4247021234"; // Formatted for 1P/3P compatibility
    ...
    /**
     * Legacy/Default method for 3P tests.
     * Defaults sellerModel to "3P".
     */
    public static DeliveryRateRequestForm createRateForm(EstimateShipMethodResponse selectedMethod) {
        return createRateForm(selectedMethod, "3P");
    }

    /**
     * Universal method for both 1P and 3P.
     * Logic branches based on sellerModel ("1P" or "3P").
     */
    public static DeliveryRateRequestForm createRateForm(EstimateShipMethodResponse selectedMethod, String sellerModel) {
    ...
    public static CreateQuotePayload buildQuotePayload(JsonNode rateResponse, EstimateShipMethodResponse selectedMethod) {
        try {
            // Safety Check: If previous step failed/returned 503, this node might be missing
            if (rateResponse == null || !rateResponse.has("rateQuote")) {
                throw new RuntimeException("Cannot build quote: Missing 'rateQuote' in response. (Did the Delivery Rate call fail?)");
            }
            ...
            return CreateQuotePayload.builder()
                    .addressInformation(AddressInformation.builder()
                            .shippingAddress(buildQuoteShippingAddress())
                            .billingAddress(buildQuoteBillingAddress())
                            ...
                            .shippingDetail(QuoteShippingDetail.builder()
                                    ...
                                    .address(buildQuoteDetailAddress())
                                    .build())
                            .build())
    ...
    public static SubmitOrderRequest createOrderRequest(String encryptedCardData) {
        ...
        paymentMap.put("billingAddress", buildPaymentBillingAddressMap());
