...
#   And I trigger the order export to Mirakl
  ...
  Scenario: 3P Order Creation by Vendor Alone CompanyBox Multi-Item Order with Mixed Quantities
    Given I initialize the FedEx session
    When I search for the following products:
      | productName            |
      | Custom Box Sample Pack |
